        ...
        <Navbar />
            <main className="container mx-auto px-3 pb-12">
                ...
                <p className="mb-4 text-2xl font-light">
                    ...
                    <p className='py-4'>Github DISCOVER is part of my personal projects developed in order to deepen my knowledge in the React framework, alongside with new skills using its vast component libraries.</p>
                    <p className="py-4">Libraries used in this project:</p>
                    <div>
